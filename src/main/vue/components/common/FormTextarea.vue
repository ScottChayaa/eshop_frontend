<template>
  <div class="form-textarea-wrapper">
    ...
    <div v-if="showCharacterCount" class="character-count mt-1 text-caption text-right">
...
.form-textarea :deep(.v-field--error .v-field__outline) {
...
.form-textarea :deep(.v-input__details) {
  margin-top: 4px;
}

.form-textarea :deep(.v-messages) {
  font-size: 0.75rem;
  min-height: 16px;
}

.form-textarea :deep(.v-field__input) {
  padding: 12px 16px;
}

.form-textarea :deep(.v-field__input textarea) {
  line-height: 1.5;
}
</style>